...
public class Mat4 extends Mat {
	...
	public static final Mat4 rotate(final Vec3 rotation, final Mat4 src, Mat4 dst) {

		if (dst == null) dst = new Mat4();

		Mat4.rotate(Mathf.toRadians(rotation.x), Vec3.RIGHT, src, dst);
		Mat4.rotate(Mathf.toRadians(rotation.y), Vec3.UP, src, dst);
		Mat4.rotate(Mathf.toRadians(rotation.z), Vec3.BACKWARD, src, dst);
	 ...
	 *            The buffer to store this matrix in
	 */
	public Mat store3f(final FloatBuffer buf) {
		buf.put(m00);
		buf.put(m01);
		buf.put(m02);
		buf.put(m10);
	 ...
	 * @return this
	 */
	public Mat4 translate(final Vec2 vec) {
	 ...
	 * @return this
	 */
	public Mat4 translate(final Vec3 vec) {
		return translate(vec, this);
	}
	 ...
	 * @return this
	 */
	public Mat4 scale(final Vec3 vec) {
	 ...
	 */
	public static Mat4 scale(final Vec3 vec, final Mat4 src, Mat4 dest) {
		if (dest == null) dest = new Mat4();
	 ...
	 * @return this
	 */
	public Mat4 rotate(final float angle, final Vec3 axis) {
	 ...
	 */
	public Mat4 rotate(final float angle, final Vec3 axis, final Mat4 dest) {
	 ...
	 * @return The rotated matrix
	 */
	public static Mat4 rotate(final float angle, final Vec3 axis, final Mat4 src, Mat4 dest) {
		if (dest == null) dest = new Mat4();
	 ...
	 */
	public Mat4 translate(final Vec3 vec, final Mat4 dest) {
	 ...
	 * @return The translated matrix
	 */
	public static Mat4 translate(final Vec3 vec, final Mat4 src, Mat4 dest) {
		if (dest == null) dest = new Mat4();
	 ...
	 * @return the translated matrix
	 */
	public Mat4 translate(final Vec2 vec, final Mat4 dest) {
		return translate(vec, this, dest);
	}
	 ...
	 * @return The translated matrix
	 */
	public static Mat4 translate(final Vec2 vec, final Mat4 src, Mat4 dest) {
		if (dest == null) dest = new Mat4();
